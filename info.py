...
RESULT_ARCHIVE_CHANNEL = int(environ.get('RESULT_ARCHIVE_CHANNEL', '-100'))  # Private DB channel where every auto-generated search-result post gets saved before auto-delete
