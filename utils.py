...
async def group_setting_buttons(grp_id):
    ...
    buttons = [[
                ...
                InlineKeyboardButton('ʀᴇsᴜʟᴛ ᴄᴀʀᴅ', callback_data=f'setgs#result_card#{settings.get("result_card", False)}#{grp_id}',),
                InlineKeyboardButton('✔ Oɴ' if settings.get("result_card") else '✘ Oғғ', callback_data=f'setgs#result_card#{settings.get("result_card", False)}#{grp_id}',),
            ],[
                InlineKeyboardButton('ᴘᴏsᴛ sᴛʏʟᴇ ᴅʟ', callback_data=f'setgs#post_style_dl#{settings.get("post_style_dl", False)}#{grp_id}',),
                InlineKeyboardButton('✔ Oɴ' if settings.get("post_style_dl") else '✘ Oғғ', callback_data=f'setgs#post_style_dl#{settings.get("post_style_dl", False)}#{grp_id}',),
            ],[
                InlineKeyboardButton('ᴘᴏsᴛᴇʀ ᴛʜᴜᴍʙ', callback_data=f'setgs#poster_thumb#{settings.get("poster_thumb", False)}#{grp_id}',),
                InlineKeyboardButton('✔ Oɴ' if settings.get("poster_thumb") else '✘ Oғғ', callback_data=f'setgs#poster_thumb#{settings.get("poster_thumb", False)}#{grp_id}',),
            ],[
